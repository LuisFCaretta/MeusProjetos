...
data_f.place(x=30, y=200)
data_entry_f = DateEntry(frame_baixo, width=25, background="gray", foreground="white", borderwidth=2)
data_entry_f.place(x=13, y=230)

#Botões
btn_inserir = Button(frame_baixo, command=inserir, text="Inserir", width=10, font=("Times 10 bold"), bg=co2, fg=co1, relief="solid", overrelief="ridge")
btn_inserir.place(x=13, y=340)

btn_atualizar = Button(frame_baixo, command=atualizar, text="Atualizar", width=10, font=("Times 10 bold"), bg=co6, fg=co1, relief="solid", overrelief="ridge")
btn_atualizar.place(x=103, y=340)

btn_apagar = Button(frame_baixo, command=deletar, text="Apagar", width=10, font=("Times 10 bold"), bg=co7, fg=co1, relief="solid", overrelief="ridge")
