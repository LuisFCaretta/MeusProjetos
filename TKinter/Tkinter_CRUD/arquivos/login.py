...
def telaCadastro():
    ...
    btn_voltar = customtkinter.CTkButton(frame_baixo, text="Ir para login", text_font=("Arial 18 bold"), width=150, fg_color="#348feb", height=10, command=telaLogin)
    btn_voltar.place(x=75, y=400)

btn_login = customtkinter.CTkButton(frame_baixo, text="Login", text_font=("Arial 24 bold"), width=200, fg_color="#348feb", height=10, command=telaLogin)
